...
\subsection*{Q1: Quais são as arquiteturas de hardware predominantes em sistemas de telemetria veicular de baixo custo?}
...
\subsection*{Q2: Quais estratégias de atuação são utilizadas para implementar mecanismos de segurança ativa, como controle de ignição e geração de alertas automáticos?}
...
\subsection*{Q3: Como os dados de telemetria são integrados, processados e visualizados em plataformas externas, como sistemas em nuvem, aplicações web e interfaces móveis?}
